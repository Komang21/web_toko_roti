            ...
            <div class="p-6 max-w-md mx-auto bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('produk.update', $produk) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $produk->nama) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('nama') border-red-500 @enderror" required>
                        @error('nama')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="stok" value="{{ old('stok', $produk->stok) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('stok') border-red-500 @enderror" required>
                        @error('stok')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
